...
test( 'normalizes quantities into the bounded remembered range', () => {
...
test( 'deduplicates invalid and repeated product IDs while preserving order', () => {
...
test( 'caps the product response to the V1 item bound', () => {
	const response = model.normalizeResponse( {
