...
/**
 * Keep the account surface deterministic in the pinned wp-env install.
 *
 * WooCommerce does not guarantee that its optional pages have been created
 * in a fresh test database, so the browser contract provisions only the
 * standard My Account shortcode page when the configured page is missing.
 */
...
// The latest eligible order determines the remembered quantity for repeated items.
...
// These statuses must not leak into the Buy Again result.
