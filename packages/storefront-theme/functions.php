...
function bhaivatech_grocery_alpha_register_block_styles(): void {
	...
	wp_enqueue_block_style(
		'bhaivatech-storefront/product-workspace',
		array(
			'handle' => 'bhaivatech-grocery-alpha-market-ledger-premium',
			'src'    => get_theme_file_uri( 'assets/css/market-ledger-premium.css' ),
			'path'   => get_theme_file_path( 'assets/css/market-ledger-premium.css' ),
			'ver'    => wp_get_theme()->get( 'Version' ),
		)
	);
