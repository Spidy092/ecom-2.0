...
Do not ship until the existing Search, Cart, Saved, mobile nav, Adaptive Department Browse, and Delivery regressions remain green in pinned WordPress + WooCommerce + Chrome, plus new real-browser tasks for availability, price, attributes, clear/reset, narrow screens, and empty filtered results.
